...
#best discriminator
projection <- sparsediscrim::hdrda(cbind(dist1, dist2), c(rep(1, 20), rep(2, 20)), lambda = 0)
...
# png("~/Downloads/knn.png", height = 600, width = 600)
plot(decision.points[,2] ~ decision.points[,1], col = reds, pch = 19, cex = .3, xlab = "", ylab = "")
...
# png("~/Downloads/pls.png", height = 600, width = 600)
plot(decision.points[,2] ~ decision.points[,1], col = reds, pch = 19, cex = .3, xlab = "", ylab = "")
...
# png("~/Downloads/rf.png", height = 600, width = 600)
plot(decision.points[,2] ~ decision.points[,1], col = reds, pch = 19, cex = .3, xlab = "", ylab = "")
...
model.nn <- train(cl ~ ., data = nn.df, method = 'mlp')
...
# png("~/Downloads/nn.png", height = 600, width = 600)
plot(decision.points[,2] ~ decision.points[,1], col = reds, pch = 19, cex = .3, xlab = "", ylab = "")
